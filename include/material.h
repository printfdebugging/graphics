...
struct material MATERIALS[MATERIAL_TYPES_LENGTH] = {
        ...
        [BLACK_PLASTIC]  = { {{ 0.0f, 0.0f, 0.0f }},                {{ 0.01f, 0.01f, 0.01f }},             {{ 0.50f, 0.50f, 0.50f }},                   0.25f       },
        [CYAN_PLASTIC]   = { {{ 0.0f, 0.1f, 0.06f }},               {{ 0.0f, 0.50980392f, 0.50980392f }},  {{ 0.50196078f, 0.50196078f, 0.50196078f }}, 0.25f       },
        [GREEN_PLASTIC]  = { {{ 0.0f, 0.0f, 0.0f }},                {{ 0.1f, 0.35f, 0.1f }},               {{ 0.45f, 0.55f, 0.45f }},                   0.25f       },
        [RED_PLASTIC]    = { {{ 0.0f, 0.0f, 0.0f }},                {{ 0.5f, 0.0f, 0.0f }},                {{ 0.7f, 0.6f, 0.6f }},                      0.25f       },
        [WHITE_PLASTIC]  = { {{ 0.0f, 0.0f, 0.0f }},                {{ 0.55f, 0.55f, 0.55f }},             {{ 0.70f, 0.70f, 0.70f }},                   0.25f       },
        [YELLOW_PLASTIC] = { {{ 0.0f, 0.0f, 0.0f }},                {{ 0.5f, 0.5f, 0.0f }},                {{ 0.60f, 0.60f, 0.50f }},                   0.25f       },
        [BLACK_RUBBER]   = { {{ 0.02f, 0.02f, 0.02f }},             {{ 0.01f, 0.01f, 0.01f }},             {{ 0.4f, 0.4f, 0.4f }},                      0.078125f   },
        [CYAN_RUBBER]    = { {{ 0.0f, 0.05f, 0.05f }},              {{ 0.4f, 0.5f, 0.5f }},                {{ 0.04f, 0.7f, 0.7f }},                     0.078125f   },
        [GREEN_RUBBER]   = { {{ 0.0f, 0.05f, 0.0f }},               {{ 0.4f, 0.5f, 0.4f }},                {{ 0.04f, 0.7f, 0.04f }},                    0.078125f   },
        [RED_RUBBER]     = { {{ 0.05f, 0.0f, 0.0f }},               {{ 0.5f, 0.4f, 0.4f }},                {{ 0.7f, 0.04f, 0.04f }},                    0.078125f   },
        [WHITE_RUBBER]   = { {{ 0.05f, 0.05f, 0.05f }},             {{ 0.5f, 0.5f, 0.5f }},                {{ 0.7f, 0.7f, 0.7f }},                      0.078125f   },
        [YELLOW_RUBBER]  = { {{ 0.05f, 0.05f, 0.0f }},              {{ 0.5f, 0.5f, 0.4f }},                {{ 0.7f, 0.7f, 0.04f }},                     0.078125f   },
};
/* clang-format on */
